...
//}
//}
//oForm.total.value = (total*field.value)-(field.value*field.value); //out
//}
	...
	var obj = document.getElementsByTagName("input");
	      for(var i=0; i<obj.length; i++){
	         ...
	         if(obj[i].name == "amt[]"){
	          		if(qty > 0 && rate > 0){obj[i].value = parseFloat((rate*1 +(rate*vat/100)) - ((rate*1 + rate*vat/100)*(dsc/100)) * qty).toFixed(2);total+=(obj[i].value*1+(ser*1));}
...
$(document).ready(function(){
    ...
    var rowTemp = [
                   ...
                   '<td><a id="deleteRow"><img src="/lan_inventory/media/autocomplete/images/icon-minus.png" alt="Remove Item" title="Remove Item"></a></td>', 
                    ...
                    '<td><input required placeholder="Quantity" type="text" name="qty[]" id="qty" onKeyUp="getValues()" style="width:50px;"></td>',
