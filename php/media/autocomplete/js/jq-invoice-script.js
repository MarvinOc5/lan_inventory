...
$(document).ready(function(){
    ...
    $('#itemCode').autocomplete({
        source: '/lan_inventory/media/autocomplete/data/invoice-data.php',
        minLength: 1,
    ...
    var rowTemp = [
                   ...
                   '<td><input required name="rate[]"  	id="itemPrice" style="width:60px;"></td>',
                   ...
                   '<td><input name="vat[]" id="vat" onKeyUp="getValues()" style="width:40px;" value="12"></td>',
					'<td><input type="text" id="dsc" name="dsc[]" id="dsc" onKeyUp="getValues()" style="width:40px;"></td>',
