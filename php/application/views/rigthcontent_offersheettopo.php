   <script  type="text/javascript" src="<?php echo $base ?>/media/autocomplete/js/jq-ae-script.js"></script>
...
<link rel="stylesheet" type="text/css" href="<?php echo $base ?>/media/autocomplete/css/styles.css" />
 ...
 <div class="right_content"><?php foreach($offersheets as $offer):?>
	<?php echo form_open('cinventory/offersheettopo/'.$offer->offersheetid);?>
    <h2>Offer Sheet to Purchase Order Form</h2>
	<table>
			<tr>
				<th align="left">Purchase Order Number:</th>
				<td><input required type="text" name="purchaseordernumber" id=""  value=""  /><?php echo form_error('purchaseordernumber'); ?></td>
                    ...
                    <div id="messageBox" style="margin-left:15px; padding-left:20px; padding-bottom:5px; border:1px #ccc solid; display:none;"></div>
                                ...
                                <table id="itemsTable" class="general-table">
                                    ...
                                    <tbody><?php foreach($offersheetsDetail as $offerdetails):?>
                                        <tr class="item-row">
											<td><a id="deleteRow"><img src="http://localhost/pnl_inventory/media/autocomplete/images/icon-minus.png" alt="Remove Item" title="Remove Item"></a></td>
                                            <td><input required placeholder="Reference Number"  name="itemCode[]" value="<?php echo $offerdetails->number; ?>"  id="itemCode" tabindex="1"/><input name="itemId[]" value="<?php echo $offerdetails->itemid?>" type="hidden" class="tInput" id="itemId" readonly="readonly" /> </td>
                                            <td><input name="itemDesc[]" value="<?php echo $offerdetails->description; ?>" readonly="readonly" class="Desc" id="itemDesc"   /></td>
                                            <td><input type="text"  name="rate[]" value="<?php echo $offerdetails->itemcost; ?>" id="itemPrice" onkeyup="getValues()" style="width:80px;" onBlur=""></td>
                                            <td><input required placeholder="Quantity" type="text" name="qty[]" value="<?php echo $offerdetails->itemquantity; ?>"  onKeyUp="getValues()" style="width:80px;" value=""></td>
                                            <td><input type="text" name="vat[]" onKeyUp="getValues()" style="width:80px;" value="<?php echo $offerdetails->itemtax?>"></td>
											<td><input placeholder="Discount" name="dsc[]" id="dsc" onKeyUp="getValues()" style="width:50px;" value="<?php echo $offerdetails->itemdiscount; ?>"></td>
    								...
    								<tr>
	        							...
	        							<td colspan="1"  class="rounded-foot-left" align="right">Delivery<input required type="text" name="del" id="del" onKeyUp="getValues()" style="width:100px;" value="<?php echo $offer->deliverycharges; ?>"> </td>
									...
									<div class="extra">	
									<input type="button" class="reload" value="Reload" onClick="location='<?php echo $base ?>/cinventory/offersheettopo/<?php echo $id ?>'"> 
