...
<table id="tablesorter" class="rounded-corner">
    ...
    <tbody>
			...
			<tr>
				...
				<?php if($purchaseorder->purchaseorderstatus=='pending'){ ?>
				<td><a href="<?php echo $base;?>/cinvoice/purchaseordertoinvoice/<?php echo $purchaseorder->purchaseorderid;?>" class="ico edit"><img src="<?php echo $base ?>/media/css/images/to.png" alt="" title="" border="0" /></a></td> 
				 <?php }  
				 else { ?>
				<td>Already Transfered</td>
				<?php } ?>
