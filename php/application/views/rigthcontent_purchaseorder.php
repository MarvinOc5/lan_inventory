...
<link rel="stylesheet" type="text/css" href="<?php echo $base ?>/media/autocomplete/css/styles.css" />
 ...
 <div class="right_content">
	<?php echo form_open('cinventory/createpurchaseorder');?>
	...
	<table>
			...
			<td><input type="text" name="daypayment" id="" size="10" value="30" /></td>
			</tr>
			<tr>
			<th align="left">Time of Shipment:</th>
			<td><input type="text" name="dayship" id="" size="10" value="" /></td>
			</tr>
                                ...
                                <table id="itemsTable" class="general-table">
                                    ...
                                    <tbody>
                                        <tr class="item-row">
                                            ...
                                            <td><input type="text" name="vat[]" id="vat" onKeyUp="getValues()" style="width:50px;" value="12"></td>
											<td><input type="text" name="dsc[]" id="dsc" onKeyUp="getValues()" style="width:50px;"></td>
									...
									<div class="extra">	
									<input type="button" class="reload" value="Reload" onClick="location='<?php echo $base ?>/cinventory/createpurchaseorder'"> 
