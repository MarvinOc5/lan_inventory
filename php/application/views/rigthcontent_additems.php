         ...
         <form action="<?php echo $base.$addlink?> " method="post" class="niceform">
                ...
                <fieldset>
                    <dl>
                        ...
                        <dd><?php $data = array("name"=>"number", "id"=>"number", "size"=>"54", ); echo form_input($data);?></dd>
                    </dl>
                    <dl>
						...
						?>
          				<dl>
          				       ...
          				       <dd><?php echo form_dropdown('modelid',$model_options); ?></dd>
          				</dl>
          				<dl>
          				       <dt><label for="Category">Category:</label></dt>
          				       <dd><?php echo form_dropdown('partscategoryid',$category_options); ?></dd>
          				</dl>
          			<?php	}	?>
                    <dl>
                        <dt><label for="cost">Cost:</label></dt><?php  echo form_error('cost'); ?>
                        <dd><?php $data = array("name"=>"cost", "id"=>"cost", "size"=>"54", ); echo form_input($data);?></dd>
                    </dl>
                     <dl>
                        <dt><label for="price">Price:</label></dt><?php  echo form_error('price'); ?>
                        <dd><?php $data = array("name"=>"price", "id"=>"price", "size"=>"54", ); echo form_input($data);?></dd>
                    </dl> 
                     <dl>
                        <dt><label for="location">Location:</label></dt><?php  echo form_error('location'); ?>
                        <dd><?php $data = array("name"=>"location", "id"=>"location", "size"=>"54", ); echo form_input($data);?></dd>
                    </dl>                    
