  <script  type="text/javascript" src="<?php echo $base ?>/media/autocomplete/js/jq-posupplier-script.js"></script>
...
<link rel="stylesheet" type="text/css" href="<?php echo $base ?>/media/autocomplete/css/styles.css" />
 ...
 <div class="right_content">
	<?php echo form_open('cinventory/createpurchaseordersupplier');?>
	...
	<table>
			...
			<td><input type="text" name="daypayment" id="" size="1" value="30" /></td>
			</tr>
			<tr>
			<th align="left">Time of Shipment:</th>
			<td><input type="text" name="dayship" id="" size="1" value="30" /></td>
			</tr>
                ...
                <div class="content inpad">
                    ...
                    <div id="messageBox" style="margin-left:15px; padding-left:20px; padding-bottom:5px; border:1px #ccc solid; display:none;"></div>
                                ...
                                <table id="itemsTable" class="general-table">
                                    ...
                                    <tfoot>
    								<tr>
    								<td colspan="3"><a href="#" id="addRow" class="button-clean large"><span> <img src="<?php echo $base ?>/media/autocomplete/images/icon-plus.png" alt="Add" title="Add Row" /> Add Item</span></a><?php if(!form_error('itemId[]')&&!form_error('qty[]')&&!form_error('vat[]')){ Echo "";} else echo(" Please Complete the Following data needed"); ?></td>
        							<td></td>
