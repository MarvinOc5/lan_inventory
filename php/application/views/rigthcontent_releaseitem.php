 ...
 <div class="right_content">
	<?php echo form_open('cinventory/deductitem');?>
    <h2>Deduct Item</h2> 
	<table>
			<tr>
			<th align="left">Company Name: <input required autofocus  type="text" name="cname" />
			<td></td>
			</tr>
			<tr>
                ...
                <div class="content inpad">
                    ...
                    <div id="messageBox" style="margin-left:15px; padding-left:20px; padding-bottom:5px; border:1px #ccc solid; display:none;"></div>
                                ...
                                <table id="itemsTable" class="general-table">
                                    ...
                                    <tfoot>
    								<tr>
    								<td colspan="4"><a href="#" id="addRow" class="button-clean large"><span> <img src="<?php echo $base ?>/media/autocomplete/images/icon-plus.png" alt="Add" title="Add Row" /> Add Item</span></a></td>
